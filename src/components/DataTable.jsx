...
export default function Datatable() {
  ...
  const saveProduct = async () => {
    if (product.name.trim()) {
      ...
      const submitData = await request(
        "/api/citizen/add",
        "POST",
        JSON.stringify({ ...product, fullName: product.name })
      );
  ...
  const homeAddress = (data) => {
    return <div>{data.home && data.home.address}</div>;
  };
      ...
      >
        ...
        <div className="field">
          ...
          {submitted && !product.idNumber && (
            <small className="p-error">ID number is required.</small>
          )}
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <InputText
            id="homeId"
            value={product.homeId}
            onChange={(e) => onInputChange(e, "homeId")}
            required
            autoFocus
            className={classNames({
          ...
          />
          {submitted && !product.homeId && (
            <small className="p-error">homeId is required.</small>
          )}
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <InputText
            ...
            required
            autoFocus
            className={classNames({ "p-invalid": submitted && !product.dob })}
          />
